        ...
        <>
            <Form onSubmit={realizarEnvio}>
                <Form.Group>
                    ...
                    <Form.Control type="text" value={celular} onChange={cambioCelular} placeholder="Email"></Form.Control>
                    <Form.Control type="text" value={lugar} onChange={cambioLugar} placeholder="Password"></Form.Control>
                </Form.Group>
